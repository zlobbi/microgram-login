...
upload.addEventListener('click', function () {
   ...
   let im = elem.getElementsByTagName('input').namedItem('image');
   let des = elem.getElementsByTagName('textarea').namedItem('description');
   addPost(createPostElement(new Post(im, des, "22.01.2019")));
});
